...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/16 12:21:18 by baecoliv          #+#    #+#             */
/*   Updated: 2025/07/16 12:27:23 by baecoliv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	execute_common_moves(t_stack *cheapest, t_stack **head_a,
		t_stack **head_b, int common_moves)
{
...
void	calculate_moves(t_stack *cheapest, int *common_moves, int *diff_a,
		int *diff_b)
{
