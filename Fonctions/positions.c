...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/16 12:31:53 by baecoliv          #+#    #+#             */
/*   Updated: 2025/07/16 12:31:58 by baecoliv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../Includes/push_swap.h"

void	position_cheapest_to_top_b(t_stack *cheapest, t_stack **head_b,
		int max_iterations)
{
	int	count;
...
void	position_target_to_top_a(t_stack *target_node, t_stack **head_a,
		int max_iterations)
{
	int	count;
